#!/bin/bash
# =============================================================================
# Confluence Demo Deployment Script
# =============================================================================
...
setup() {
    ...
    mkdir -p /opt/confluence-demo
    mkdir -p /opt/confluence-demo/secrets

    echo_info "Setup complete!"
    echo ""
    echo "Next steps:"
    echo "  1. Copy your project files to /opt/confluence-demo"
    echo "  2. Configure secrets in /opt/confluence-demo/secrets/"
...
deploy() {
    echo_step "Deploying Confluence Demo..."
    ...
    docker build -t confluence-demo-container:latest ./demo-container
...
update() {
    echo_step "Updating Confluence Demo..."
