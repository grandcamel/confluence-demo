#!/bin/bash
# =============================================================================
# Confluence Demo Auto-Play Script (Streaming Version)
# =============================================================================
...
show_usage() {
    ...
    echo ""
    echo "Scenarios: page, search, space, hierarchy, label, comment, attachment,"
    echo "           permission, bulk, analytics, template"
    echo ""
    echo "Options:"
    ...
    echo ""
    echo "Examples:"
    echo "  $0 page                     # Run page scenario, press key to advance"
    echo "  $0 --auto-advance search    # Auto-advance with 3s delay"
    echo "  $0 -a -d 5 hierarchy        # Auto-advance with 5s delay"
    echo "  $0 -t page                  # Show tool usage details"
    echo "  $0 --debug page             # Debug mode with JSON logging"
}
